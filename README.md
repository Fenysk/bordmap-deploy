...
app/
  ...
  components/    # RouteMap (contrat 3b)
...
```bash
VITE_CONVEX_URL=http://localhost:3210 ./docker/smoke.sh
...
Pas de secrets dans le repo. `.env.local` est gitignored.
